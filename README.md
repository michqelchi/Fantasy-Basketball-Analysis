Fantasy basketball value analysis project (based off ESPN points leagues ADP data and expert points league projections).

ADP data was pulled from ESPN website on 9/23/26

Expert rankings were complied from 5 different sources: ESPN, Yahoo, LeagueWinner, LineupExperts, and FantasyPros.
